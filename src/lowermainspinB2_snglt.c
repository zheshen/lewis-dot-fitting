...
double lowermainspinB2_snglt(){

	extern char directory[];
	extern int print;

        extern double U_spinB2_snglt;
	extern double U_spinB2_snglt_linnett;
	extern double U_spinB2_snglt_snglbnd;
	extern double U_spinB2_snglt_dblbnd;
	extern double U_spinB2_snglt_trplbnd;


	char molecule[] = "BORON  DIATOMIC SNG MIN";
	...
	Species spec;
	spec.icue = 4;
	strcpy(spec.fullname, "B2_snglt");			//Enter full name for the structure
	strcpy(spec.name, "B2_snglt");				//Enter abbreviation name
	strcpy(spec.spin, "a3b3");				//Enter spin structure
	spec.type = B2_snglt;					//Enter type name
	...
	Species dblbnd;
	Species trplbnd;
	linnett.type = B2_snglt_linnett;
	snglbnd.type = B2_snglt_snglbnd;
	dblbnd.type = B2_snglt_dblbnd;
	trplbnd.type = B2_snglt_trplbnd;
	specSwitch(&linnett);
	specSwitch(&snglbnd);
	specSwitch(&dblbnd);
	specSwitch(&trplbnd);
...
#pragma omp section 
                        	{	
//					if (wspinB2_snglt_linnett)
					(*linnett.ainter)(&linnett);
//					else U_spinB2_snglt_linnett = 0.0;
				}
#pragma omp section 
				{
//					if (wspinB2_snglt_snglbnd)
					(*snglbnd.ainter)(&snglbnd);
//					else U_spinB2_snglt_snglbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinB2_snglt_dblbnd)
					(*dblbnd.ainter)(&dblbnd);
//					else U_spinB2_snglt_dblbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinB2_snglt_trplbnd)
      					(*trplbnd.ainter)(&trplbnd);
//					else U_spinB2_snglt_trplbnd = 0.0;
				}
			}
			}


//					U_spinB2_snglt_linnett = (*linnett.ainter)(&linnett);
//					U_spinB2_snglt_snglbnd = (*snglbnd.ainter)(&snglbnd);
//					U_spinB2_snglt_dblbnd = (*dblbnd.ainter)(&dblbnd);
//					U_spinB2_snglt_trplbnd = (*trplbnd.ainter)(&trplbnd);
//					printf("%f, %f, %f, %f\n", U_spinB2_snglt_linnett, U_spinB2_snglt_snglbnd, U_spinB2_snglt_dblbnd, U_spinB2_snglt_trplbnd);

			U_spinB2_snglt=fmin(fmin(fmin(U_spinB2_snglt_linnett,U_spinB2_snglt_snglbnd),U_spinB2_snglt_dblbnd),U_spinB2_snglt_trplbnd); //spinB2_snglt (triplet)
			if (U_spinB2_snglt==U_spinB2_snglt_linnett)
			{
			...
			else if(U_spinB2_snglt==U_spinB2_snglt_snglbnd)
			{
			...
			else if(U_spinB2_snglt==U_spinB2_snglt_dblbnd)
			{
			...
			else if(U_spinB2_snglt==U_spinB2_snglt_trplbnd)
			{
...
//				deviation = 5E5;
			...
			if (print){
				...
				fprintf(OutFile, "|-------------------------------------------------------------------------------------------------------------------------|\n");
			        ...
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Linnett      |  % 7.5e  |", U_spinB2_snglt_linnett );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Snglbnd      |  % 7.5e  |", U_spinB2_snglt_snglbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Dblbnd       |  % 7.5e  |", U_spinB2_snglt_dblbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Trplbnd      |  % 7.5e  |", U_spinB2_snglt_trplbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
				...
				printEnergy(U_spinB2_snglt);

                        extern int writefinalpdb;
                        if ((writefinalpdb)&&(spec.icue==4)){output(spec.coord, spec.numPart, "spinB2_snglt_min_final.pdb");}
