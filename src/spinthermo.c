...
//	prod[0]= thermo208;
//	prod[1]= thermo209;
	prod[0]= thermo5-0.001;
	prod[1]= thermo6-0.001;
	prod[2]= thermo210-0.001;
	prod[3]= thermo211-0.001;
	prod[4]= LitThermo1 * thermo1 - 0.001;
	prod[5]= thermo224-0.001;
	prod[6]= thermo18-0.001;
	prod[7]= thermo19-0.001;
//	prod[6]= thermo234;
//	prod[7]= thermo235;
//	prod[8]= thermo236;
	prod[9]= LitThermo244 * thermo244 - 0.001;
...
//	prod[13]=LitThermo248 * thermo248;
	...
	//Zn sign			
	prod[0] = LitThermo463*thermo463 - 0.001;
	prod[1] = thermo464 - 0.001;
	prod[2] = thermo465 - 0.001;
	prod[3] = thermo466 - 0.001;
	prod[4] = thermo467 - 0.001;
	prod[5] = thermo468 - 0.001;
	prod[6] = thermo469 - 0.001;
	prod[7] = thermo470 - 0.001;
	prod[8] = thermo471 - 0.001;
	prod[9] = thermo472 - 0.001;
	prod[10] = thermo473 - 0.001;
	prod[11] = thermo474 - 0.001;
	prod[12] = thermo475 - 0.001;
	prod[13] = thermo476 - 0.001;
	prod[14] = thermo477 - 0.001;
	prod[15] = thermo478 - 0.001;
	prod[16] = thermo479 - 0.001;
	prod[17] = thermo480 - 0.001;
	prod[18] = thermo481 - 0.001;
	prod[19] = thermo482 - 0.001;
	prod[20] = thermo483 - 0.001;
	prod[21] = thermo484 - 0.001;
	prod[22] = thermo485 - 0.001;
	prod[23] = LitThermo486 * thermo486 - 0.001;
	prod[24] = LitThermo487 * thermo487 - 0.001;
	prod[25] = LitThermo488 * thermo488 - 0.001;
	prod[26] = LitThermo489 * thermo489 - 0.001;
	prod[27] = LitThermo490 * thermo490 - 0.001;
	prod[28] = LitThermo491 * thermo491 - 0.001;
	prod[29] = LitThermo492 * thermo492 - 0.001;
	prod[30] = LitThermo493 * thermo493 - 0.001;
	prod[31] = LitThermo494 * thermo494 - 0.001;
	prod[32] = LitThermo495 * thermo495 - 0.001;
	prod[33] = LitThermo496 * thermo496 - 0.001;
	prod[34] = LitThermo497 * thermo497 - 0.001;
	prod[35] = thermo701 - 0.001;
	prod[36] = thermo702 - 0.001;
	prod[37] = thermo703 - 0.001;
	prod[38] = thermo704 - 0.001;
	prod[39] = thermo705 - 0.001;
	prod[40] = thermo706 - 0.001;
	prod[41] = thermo707 - 0.001;
	prod[42] = thermo708 - 0.001;
	prod[43] = thermo709 - 0.001;
	prod[44] = thermo710 - 0.001;
