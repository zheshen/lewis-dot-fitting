...
double spinthermo(){
	...
	extern double U_spinClplusex2;
	extern double U_spinClplusex;
	extern double U_spinClplus;
	...
	extern double U_spinAlplusex;
	extern double U_spinAlplus;
	extern double U_spinAlplus2;

	extern double U_spinB_1;
	extern double U_spinBneutrlex;
	extern double U_spinBneutrl;
	extern double U_spinBplusex;
	extern double U_spinBplus;
...
//	thermo31 = U_spinO_2;
	...
	thermo45 = U_spinCplus - U_spinCplus2;
	thermo46 = U_spinCneutrl - U_spinCplus;
	...
	thermo51 = U_spinNplus - U_spinNplus2;
	thermo52 = U_spinNneutrl - U_spinNplus;
	...
	thermo58 = U_spinSplus - U_spinSplus2;
	thermo59 = U_spinSneutrl - U_spinSplus;
	...
	thermo64 = U_spinPplus - U_spinPplus2;
	thermo65 = U_spinPneutrl - U_spinPplus;
	thermo66 = U_spinP_1 - U_spinPneutrl;
	thermo67 = U_spinSiplus3;
	thermo68 = U_spinSiplus2 - U_spinSiplus3;
	thermo69 = U_spinSiplus - U_spinSiplus2;
	thermo70 = U_spinSineutrl - U_spinSiplus;
	...
	thermo132 = U_spinNplusex - U_spinNplus;
	thermo133 = U_spinNplusex2 - U_spinNplus;
	...
	thermo140 = U_spinFplusex - U_spinFplus;
	thermo141 = U_spinSiplus2ex - U_spinSiplus2;
	thermo142 = U_spinSiplusex - U_spinSiplus;
	...
	thermo147 = U_spinPplusex - U_spinPplus;
	thermo148 = U_spinPplusex2 - U_spinPplus;
	...
	thermo154 = U_spinSplusex - U_spinSplus;
	...
	thermo160 = U_spinFplusex2 - U_spinFplus;
	thermo161 = U_spinFplus2ex2 - U_spinFplus2;
	thermo162 = U_spinSneutrlex2 - U_spinSneutrl;

	thermo164 = U_spinBplus2 ;
	thermo165 = U_spinBplus - U_spinBplus2;
	thermo166 = U_spinBneutrl - U_spinBplus;
	thermo167 = U_spinB_1 - U_spinBneutrl;
	thermo168 = U_spinBplusex - U_spinBplus;
	thermo169 = U_spinBneutrlex - U_spinBneutrl;
	thermo170 = U_spinBplus2 ;
	thermo171 = U_spinBplus ;
	thermo172 = U_spinBneutrl ;
	thermo173 = U_spinB_1 ;

	thermo174 = U_spinCl_1 - U_spinClneutrl;
	thermo175 = U_spinClneutrlex - U_spinClneutrl;
	thermo176 = U_spinClneutrl - U_spinClplus;
	thermo177 = U_spinClplusex2 - U_spinClplus;
	thermo178 = U_spinClplusex - U_spinClplus;
	thermo179 = U_spinClplus - U_spinClplus2;
	...
	thermo192 = U_spinAlneutrl - U_spinAlplus;
	thermo193 = U_spinAlplusex - U_spinAlplus;
	thermo194 = U_spinAlplus - U_spinAlplus2;
	thermo195 = U_spinAlplus2;
	thermo196 = U_spinCl_1;
	thermo197 = U_spinClneutrl;
	thermo198 = U_spinClplus;
...
//	deviation += fabs(dev11) * wspinOplusion;
...
//	deviation += fabs(dev21) * wspinHeaff_trp;
	...
	deviation += fabs(dev23) * wspinOplusion;
	...
	deviation += fabs(dev34) * wspinOplusion;
	...
	deviation += fabs(dev41) * wspinOplusionex;
...
//	deviation += fabs(dev118) * wspinOplusionex;
...
//	deviation += fabs(dev121) * wspinOplus4ionex;
	...
	deviation += fabs(dev45) * wspinCplusion;
	...
	deviation += fabs(dev51) * wspinNplusion;
...
//	deviation += fabs(dev53) * wspinN_1ion;
	...
	deviation += fabs(dev58) * wspinSplusion;
	...
	deviation += fabs(dev64) * wspinPplusion;
	...
	deviation += fabs(dev69) * wspinSiplusion;
	...
	deviation += fabs(dev77) * wspinFplusion;
	...
	deviation += fabs(dev82) * wspinCplusion;
	...
	deviation += fabs(dev88) * wspinNplusion;
...
//	deviation += fabs(dev90) * wspinN_1ion;
	...
	deviation += fabs(dev95) * wspinSplusion;
	...
	deviation += fabs(dev101) * wspinPplusion;
	...
	deviation += fabs(dev106) * wspinSiplusion;
	...
	deviation += fabs(dev132) * wspinNplusexion;
	deviation += fabs(dev133) * wspinNplusex2ion;
	...
	deviation += fabs(dev140) * wspinFplusexion;
	deviation += fabs(dev141) * wspinSiplus2exion;
	deviation += fabs(dev142) * wspinSiplusexion;
	...
	deviation += fabs(dev147) * wspinPplusexion;
	deviation += fabs(dev148) * wspinPplusex2ion;
...
//	deviation += fabs(dev158) * wspinNneutrlex2ion;
	...
	deviation += fabs(dev177) * wspinClplusex2ion;
	deviation += fabs(dev178) * wspinClplusexion;
	deviation += fabs(dev179) * wspinClplusion;
	...
	deviation += fabs(dev193) * wspinAlplusexion;
	deviation += fabs(dev194) * wspinAlplusion;
	...
	deviation += fabs(dev198) * wspinClplusion;
	...
	deviation += fabs(dev206) * wspinAlplusion;
...
//	deviation += fabs(dev236) * wspinHsign;
	...
	deviation += fabs(dev218) * wspinBeplusion;
	...
	deviation += fabs(dev223) * wspinMgplusion;
...
//			}
//			else if (i==2){
//				deviation += wspinOsign*100*wspinOplusion;
//				wTotal += wspinOsign*wspinOplusion;
//			}
//			else if (i==3){
...
//			}
//			else if (i==9){
//				deviation += wspinOsign*100*wspinOplusionex;
//				wTotal += wspinOsign*wspinOplusionex;
//			}
//			else if (i==10){
//				deviation += wspinOsign*100*wspinOplusex2ion;
//				wTotal += wspinOsign*wspinOplusex2ion;
//			}
//			else if (i==11){
