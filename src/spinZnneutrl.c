...
/*>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>BELOW CHANGABLE>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
	...
	//b-2 
        Vin[6+2].x = rot(-rb1, 0.0, 0.0, a, b, c, 0);
        Vin[6+2].y = rot(-rb1, 0.0, 0.0, a, b, c, 1);
        Vin[6+2].z = rot(-rb1, 0.0, 0.0, a, b, c, 2);
        Vin[6+2].q = -1;
        Vin[6+2].s = -2;
        ...
        //b-3 
        Vin[6+3].x = rot(0.0, rb1, 0.0, a, b, c, 0);
        Vin[6+3].y = rot(0.0, rb1, 0.0, a, b, c, 1);
        Vin[6+3].z = rot(0.0, rb1, 0.0, a, b, c, 2);
        Vin[6+3].q = -1;
        Vin[6+3].s = -2;
        ...
        //b-4 
        Vin[6+4].x = rot(0.0, -rb1, 0.0, a, b, c, 0);
        Vin[6+4].y = rot(0.0, -rb1, 0.0, a, b, c, 1);
        Vin[6+4].z = rot(0.0, -rb1, 0.0, a, b, c, 2);
        Vin[6+4].q = -1;
        Vin[6+4].s = -2;
        ...
        //b-5 
        Vin[6+5].x = rot(0.0, 0.0, rb1, a, b, c, 0);
        Vin[6+5].y = rot(0.0, 0.0, rb1, a, b, c, 1);
        Vin[6+5].z = rot(0.0, 0.0, rb1, a, b, c, 2);
        Vin[6+5].q = -1;
        Vin[6+5].s = -2;
        ...
        //b-6 
        Vin[6+6].x = rot(0.0, 0.0, -rb1, a, b, c, 0);
        Vin[6+6].y = rot(0.0, 0.0, -rb1, a, b, c, 1);
        Vin[6+6].z = rot(0.0, 0.0, -rb1, a, b, c, 2);
        Vin[6+6].q = -1;
        Vin[6+6].s = -2;
        Vin[6+6].d = db1_r+db1_i*I;
        Vin[6+6].eta = db2;
        Vin[6+6].zeta = db3;
