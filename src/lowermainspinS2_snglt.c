...
double lowermainspinS2_snglt(){

	extern char directory[];
	extern int print;

        extern double U_spinS2_snglt;
	extern double U_spinS2_snglt_linnett;
	extern double U_spinS2_snglt_snglbnd;
	extern double U_spinS2_snglt_dblbnd;
	extern double U_spinS2_snglt_trplbnd;


	char molecule[] = "SULFUR DIATOMIC SNG MIN";
	...
	Species spec;
	spec.icue = 4;
	strcpy(spec.fullname, "S2_snglt");			//Enter full name for the structure
	strcpy(spec.name, "S2_snglt");				//Enter abbreviation name
	strcpy(spec.spin, "a6b6");				//Enter spin structure
	spec.type = S2_snglt;					//Enter type name
	...
	Species dblbnd;
	Species trplbnd;
	linnett.type = S2_snglt_linnett;
	snglbnd.type = S2_snglt_snglbnd;
	dblbnd.type = S2_snglt_dblbnd;
	trplbnd.type = S2_snglt_trplbnd;
	specSwitch(&linnett);
	specSwitch(&snglbnd);
	specSwitch(&dblbnd);
	specSwitch(&trplbnd);
...
#pragma omp section 
                        	{	
//					if (wspinS2_snglt_linnett)
					(*linnett.ainter)(&linnett);
//					else U_spinS2_snglt_linnett = 0.0;
				}
#pragma omp section 
				{
//					if (wspinS2_snglt_snglbnd)
					(*snglbnd.ainter)(&snglbnd);
//					else U_spinS2_snglt_snglbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinS2_snglt_dblbnd)
					(*dblbnd.ainter)(&dblbnd);
//					else U_spinS2_snglt_dblbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinS2_snglt_trplbnd)
      					(*trplbnd.ainter)(&trplbnd);
//					else U_spinS2_snglt_trplbnd = 0.0;
				}
			}
			}


//					U_spinS2_snglt_linnett = (*linnett.ainter)(&linnett);
//					U_spinS2_snglt_snglbnd = (*snglbnd.ainter)(&snglbnd);
//					U_spinS2_snglt_dblbnd = (*dblbnd.ainter)(&dblbnd);
//					U_spinS2_snglt_trplbnd = (*trplbnd.ainter)(&trplbnd);
//					printf("%f, %f, %f, %f\n", U_spinS2_snglt_linnett, U_spinS2_snglt_snglbnd, U_spinS2_snglt_dblbnd, U_spinS2_snglt_trplbnd);

			U_spinS2_snglt=fmin(fmin(fmin(U_spinS2_snglt_linnett,U_spinS2_snglt_snglbnd),U_spinS2_snglt_dblbnd),U_spinS2_snglt_trplbnd); //spinS2_snglt (triplet)
			if (U_spinS2_snglt==U_spinS2_snglt_linnett)
			{
			...
			else if(U_spinS2_snglt==U_spinS2_snglt_snglbnd)
			{
			...
			else if(U_spinS2_snglt==U_spinS2_snglt_dblbnd)
			{
			...
			else if(U_spinS2_snglt==U_spinS2_snglt_trplbnd)
			{
...
//				deviation = 5E5;
			...
			if (print){
				...
				fprintf(OutFile, "|-------------------------------------------------------------------------------------------------------------------------|\n");
			        ...
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Linnett      |  % 7.5e  |", U_spinS2_snglt_linnett );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Snglbnd      |  % 7.5e  |", U_spinS2_snglt_snglbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Dblbnd       |  % 7.5e  |", U_spinS2_snglt_dblbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Trplbnd      |  % 7.5e  |", U_spinS2_snglt_trplbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
				...
				printEnergy(U_spinS2_snglt);

                        extern int writefinalpdb;
                        if ((writefinalpdb)&&(spec.icue==4)){output(spec.coord, spec.numPart, "spinS2_snglt_min_final.pdb");}
