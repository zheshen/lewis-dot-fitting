...
double lowermainspinCl2_snglt(){

	extern char directory[];
	extern int print;

        extern double U_spinCl2_snglt;
	extern double U_spinCl2_snglt_linnett;
	extern double U_spinCl2_snglt_snglbnd;
	extern double U_spinCl2_snglt_dblbnd;
	extern double U_spinCl2_snglt_trplbnd;


	char molecule[] = "CHLORINE DIATOMIC SNG MIN";
        const double real_bl= 1.99;
	...
	Species spec;
	spec.icue = 4;
	strcpy(spec.fullname, "Cl2_snglt");			//Enter full name for the structure
	strcpy(spec.name, "Cl2_snglt");				//Enter abbreviation name
	strcpy(spec.spin, "a7b7");				//Enter spin structure
	spec.type = Cl2_snglt;					//Enter type name
	...
	Species dblbnd;
	Species trplbnd;
	linnett.type = Cl2_snglt_linnett;
	snglbnd.type = Cl2_snglt_snglbnd;
	dblbnd.type = Cl2_snglt_dblbnd;
	trplbnd.type = Cl2_snglt_trplbnd;
	specSwitch(&linnett);
	specSwitch(&snglbnd);
	specSwitch(&dblbnd);
	specSwitch(&trplbnd);
...
#pragma omp section 
                        	{	
//					if (wspinCl2_snglt_linnett)
					(*linnett.ainter)(&linnett);
//					else U_spinCl2_snglt_linnett = 0.0;
				}
#pragma omp section 
				{
//					if (wspinCl2_snglt_snglbnd)
					(*snglbnd.ainter)(&snglbnd);
//					else U_spinCl2_snglt_snglbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinCl2_snglt_dblbnd)
					(*dblbnd.ainter)(&dblbnd);
//					else U_spinCl2_snglt_dblbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinCl2_snglt_trplbnd)
      					(*trplbnd.ainter)(&trplbnd);
//					else U_spinCl2_snglt_trplbnd = 0.0;
				}
			}
			}


//					U_spinCl2_snglt_linnett = (*linnett.ainter)(&linnett);
//					U_spinCl2_snglt_snglbnd = (*snglbnd.ainter)(&snglbnd);
//					U_spinCl2_snglt_dblbnd = (*dblbnd.ainter)(&dblbnd);
//					U_spinCl2_snglt_trplbnd = (*trplbnd.ainter)(&trplbnd);
//					printf("%f, %f, %f, %f\n", U_spinCl2_snglt_linnett, U_spinCl2_snglt_snglbnd, U_spinCl2_snglt_dblbnd, U_spinCl2_snglt_trplbnd);

			U_spinCl2_snglt=fmin(fmin(fmin(U_spinCl2_snglt_linnett,U_spinCl2_snglt_snglbnd),U_spinCl2_snglt_dblbnd),U_spinCl2_snglt_trplbnd); //spinCl2_snglt (triplet)
			if (U_spinCl2_snglt==U_spinCl2_snglt_linnett)
			{
			...
			else if(U_spinCl2_snglt==U_spinCl2_snglt_snglbnd)
			{
			...
			else if(U_spinCl2_snglt==U_spinCl2_snglt_dblbnd)
			{
			...
			else if(U_spinCl2_snglt==U_spinCl2_snglt_trplbnd)
			{
...
//				deviation = 5E5;
			...
			if (print){
				...
				fprintf(OutFile, "|-------------------------------------------------------------------------------------------------------------------------|\n");
			        ...
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Linnett      |  % 7.5e  |", U_spinCl2_snglt_linnett );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Snglbnd      |  % 7.5e  |", U_spinCl2_snglt_snglbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Dblbnd       |  % 7.5e  |", U_spinCl2_snglt_dblbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Trplbnd      |  % 7.5e  |", U_spinCl2_snglt_trplbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
				...
				printEnergy(U_spinCl2_snglt);

                        extern int writefinalpdb;
                        if ((writefinalpdb)&&(spec.icue==4)){output(spec.coord, spec.numPart, "spinCl2_snglt_min_final.pdb");}
