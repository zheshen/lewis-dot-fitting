...
double lowermainspinN2_trplt(){

	extern char directory[];
	extern int print;

        extern double U_spinN2_trplt;
	extern double U_spinN2_trplt_linnett;
	extern double U_spinN2_trplt_snglbnd;
	extern double U_spinN2_trplt_dblbnd;
	extern double U_spinN2_trplt_trplbnd;


	char molecule[] = "NITROGEN  DIATOMIC TRP MIN";
	...
	Species spec;
	spec.icue = 4;
	strcpy(spec.fullname, "N2_trplt");			//Enter full name for the structure
	strcpy(spec.name, "N2_trplt");				//Enter abbreviation name
	strcpy(spec.spin, "a6b4");				//Enter spin structure
	spec.type = N2_trplt;					//Enter type name
	...
	Species dblbnd;
	Species trplbnd;
	linnett.type = N2_trplt_linnett;
	snglbnd.type = N2_trplt_snglbnd;
	dblbnd.type = N2_trplt_dblbnd;
	trplbnd.type = N2_trplt_trplbnd;
	specSwitch(&linnett);
	specSwitch(&snglbnd);
	specSwitch(&dblbnd);
	specSwitch(&trplbnd);
...
#pragma omp section 
                        	{	
//					if (wspinN2_trplt_linnett)
					(*linnett.ainter)(&linnett);
//					else U_spinN2_trplt_linnett = 0.0;
				}
#pragma omp section 
				{
//					if (wspinN2_trplt_snglbnd)
					(*snglbnd.ainter)(&snglbnd);
//					else U_spinN2_trplt_snglbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinN2_trplt_dblbnd)
					(*dblbnd.ainter)(&dblbnd);
//					else U_spinN2_trplt_dblbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinN2_trplt_trplbnd)
      					(*trplbnd.ainter)(&trplbnd);
//					else U_spinN2_trplt_trplbnd = 0.0;
				}
			}
			}


//					U_spinN2_trplt_linnett = (*linnett.ainter)(&linnett);
//					U_spinN2_trplt_snglbnd = (*snglbnd.ainter)(&snglbnd);
//					U_spinN2_trplt_dblbnd = (*dblbnd.ainter)(&dblbnd);
//					U_spinN2_trplt_trplbnd = (*trplbnd.ainter)(&trplbnd);
//					printf("%f, %f, %f, %f\n", U_spinN2_trplt_linnett, U_spinN2_trplt_snglbnd, U_spinN2_trplt_dblbnd, U_spinN2_trplt_trplbnd);

			U_spinN2_trplt=fmin(fmin(fmin(U_spinN2_trplt_linnett,U_spinN2_trplt_snglbnd),U_spinN2_trplt_dblbnd),U_spinN2_trplt_trplbnd); //spinN2_trplt (triplet)
			if (U_spinN2_trplt==U_spinN2_trplt_linnett)
			{
			...
			else if(U_spinN2_trplt==U_spinN2_trplt_snglbnd)
			{
			...
			else if(U_spinN2_trplt==U_spinN2_trplt_dblbnd)
			{
			...
			else if(U_spinN2_trplt==U_spinN2_trplt_trplbnd)
			{
...
//				deviation = 5E5;
			...
			if (print){
				...
				fprintf(OutFile, "|-------------------------------------------------------------------------------------------------------------------------|\n");
			        ...
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Linnett      |  % 7.5e  |", U_spinN2_trplt_linnett );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Snglbnd      |  % 7.5e  |", U_spinN2_trplt_snglbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Dblbnd       |  % 7.5e  |", U_spinN2_trplt_dblbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Trplbnd      |  % 7.5e  |", U_spinN2_trplt_trplbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
				...
				printEnergy(U_spinN2_trplt);

                        extern int writefinalpdb;
                        if ((writefinalpdb)&&(spec.icue==4)){output(spec.coord, spec.numPart, "spinN2_trplt_min_final.pdb");}
