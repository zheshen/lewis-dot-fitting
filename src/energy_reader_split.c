...
#include "Energy.h"
/*
double kineticEnergy_split(double d0, int E_or_F, double * items){

//        extern double parKE[];

        double k = 1.0;

        return formOfKE(EkeConst, d0, k, 0, E_or_F, items);

}

double TBenergy_split(double r2, double r, double Rn2, double Rn, double Ri, double Rj, double Nx, double Ny, double Nz, double ix, double iy, double iz, double jx,\
 double jy, double jz, double dr1, double dr2, double q, int s, int E_or_Fi, double * items){
...
//	extern double parXA[];
	...
	double p13=0;
		if(s == 1){
                ...
                else if(s==21 || s==22 || s==23 || s==24 || s==25 || s==26 || s==27 || s==28 || s==29 || s==30 || 
                        s==39 || s==40 || s==41 || s==42 || s==43 || s==44 || s==45 || s==46 || s==47 || s==48){
                                p1  = parMA[0];
                                p2  = parMA[1];
                                p3  = parMA[2];
                                p4  = parMA[3];
	...
	return formOfAAX(r2, r, Rn2, Rn, Ri, Rj, Nx, Ny, Nz, ix, iy, iz, jx, jy, jz, dr1, dr2, di1, di2, q, s, pAB2, pAB7, pAB10, pAB11, pAB12, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, n1, n2, E_or_F, items);

}
*/

int energy_split(V *a, V *b, int E_or_F, double * items) {
...
//AA=BB===========================================================
                        if (sp_type ==1){
                                ...
                                //u = formOfAA_split(r_a, r_b, r2, r, dr1, dr2, di1, di2, q, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, n1, n2, n3, E_or_F, items);
                                u = formOfAA_split(a, b, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, n1, n2, n3, E_or_F, items);
				flag = 1;
			//	if((print)&&(icue_spinO>1))
...
//AB=BA============================================================
				...
				double p13  = parAB[12];	
                                ...
                                u = formOfAB_split(a, b, p1, p2, p3, p4, p5, p6, p13, n1, n2, n3, E_or_F, items);
				flag = 2;
			//	if((print)&&(icue_spinO>1))
...
//AH===============================================================
				...
				//if (diagnose_print == 1)printf("%f  %f  %f %f\n", p1, p2, p3, p4);
                                u = formOfXA_split(a, b, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, n1, n2, n3, E_or_F, items);
                         	flag = 3;
			        break;
                        }
//CA===============================================================
...
/*                     else if (m1 == 7){
				...
				//p5 = p6+p5;
                                ...
                                u = formOfXA(r_a, r_b, r2, r, dr1, dr2, di1, di2, q, p1, p2, p3, p4, p5, p6, n1, n2, n3, E_or_F);
                                break;
                        }*/
//OA===============================================================
                         else if (m1 == 8){
...
//MA===============================================================
                        else if(m1==20 || m1==21 || m1==22 || m1==23 || m1==24 || m1==25 || m1==26 || m1==27 || m1==28 || m1==29 || m1==30 ||  
                                m1==39 || m1==40 || m1==41 || m1==42 || m1==43 || m1==44 || m1==45 || m1==46 || m1==47 || m1==48){
                                double p1  = parMA[0];
                                double p2  = parMA[1];
                                double p3  = parMA[2];
                                double p4  = parMA[3];
...
//Qq===============================================================
                        if (m1 > m2){
                                ...
                                u = formOfHH(r2, r, q, p1, p2, p3, p4, n1, n2, E_or_F);
                         	flag = 4;
                                break;
                        }
