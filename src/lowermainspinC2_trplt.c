...
double lowermainspinC2_trplt(){

	extern char directory[];
	extern int print;

        extern double U_spinC2_trplt;
	extern double U_spinC2_trplt_linnett;
	extern double U_spinC2_trplt_snglbnd;
	extern double U_spinC2_trplt_dblbnd;
	extern double U_spinC2_trplt_trplbnd;


	char molecule[] = "CARBON  DIATOMIC TRP MIN";
        const double real_bl= 1.24;
	...
	Species spec;
	spec.icue = 4;
	strcpy(spec.fullname, "C2_trplt");			//Enter full name for the structure
	strcpy(spec.name, "C2_trplt");				//Enter abbreviation name
	strcpy(spec.spin, "a5b3");				//Enter spin structure
	spec.type = C2_trplt;					//Enter type name
	...
	Species dblbnd;
	Species trplbnd;
	linnett.type = C2_trplt_linnett;
	snglbnd.type = C2_trplt_snglbnd;
	dblbnd.type = C2_trplt_dblbnd;
	trplbnd.type = C2_trplt_trplbnd;
	specSwitch(&linnett);
	specSwitch(&snglbnd);
	specSwitch(&dblbnd);
	specSwitch(&trplbnd);
...
#pragma omp section 
                        	{	
//					if (wspinC2_trplt_linnett)
					(*linnett.ainter)(&linnett);
//					else U_spinC2_trplt_linnett = 0.0;
				}
#pragma omp section 
				{
//					if (wspinC2_trplt_snglbnd)
					(*snglbnd.ainter)(&snglbnd);
//					else U_spinC2_trplt_snglbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinC2_trplt_dblbnd)
					(*dblbnd.ainter)(&dblbnd);
//					else U_spinC2_trplt_dblbnd = 0.0;
				}
#pragma omp section 
				{
//					if (wspinC2_trplt_trplbnd)
      					(*trplbnd.ainter)(&trplbnd);
//					else U_spinC2_trplt_trplbnd = 0.0;
				}
			}
			}


//					U_spinC2_trplt_linnett = (*linnett.ainter)(&linnett);
//					U_spinC2_trplt_snglbnd = (*snglbnd.ainter)(&snglbnd);
//					U_spinC2_trplt_dblbnd = (*dblbnd.ainter)(&dblbnd);
//					U_spinC2_trplt_trplbnd = (*trplbnd.ainter)(&trplbnd);
//					printf("%f, %f, %f, %f\n", U_spinC2_trplt_linnett, U_spinC2_trplt_snglbnd, U_spinC2_trplt_dblbnd, U_spinC2_trplt_trplbnd);

			U_spinC2_trplt=fmin(fmin(fmin(U_spinC2_trplt_linnett,U_spinC2_trplt_snglbnd),U_spinC2_trplt_dblbnd),U_spinC2_trplt_trplbnd); //spinC2_trplt (triplet)
			if (U_spinC2_trplt==U_spinC2_trplt_linnett)
			{
			...
			else if(U_spinC2_trplt==U_spinC2_trplt_snglbnd)
			{
			...
			else if(U_spinC2_trplt==U_spinC2_trplt_dblbnd)
			{
			...
			else if(U_spinC2_trplt==U_spinC2_trplt_trplbnd)
			{
...
//				deviation = 5E5;
			...
			if (print){
				...
				fprintf(OutFile, "|-------------------------------------------------------------------------------------------------------------------------|\n");
			        ...
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Linnett      |  % 7.5e  |", U_spinC2_trplt_linnett );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Snglbnd      |  % 7.5e  |", U_spinC2_trplt_snglbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Dblbnd       |  % 7.5e  |", U_spinC2_trplt_dblbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
			
			        fprintf(OutFile, "| Potential Energy      |   kJ/mol   |      -         |   -   |   Trplbnd      |  % 7.5e  |", U_spinC2_trplt_trplbnd );
			        fprintf(OutFile, "   N/A   |       -       |\n");
				...
				printEnergy(U_spinC2_trplt);

                        extern int writefinalpdb;
                        if ((writefinalpdb)&&(spec.icue==4)){output(spec.coord, spec.numPart, "spinC2_trplt_min_final.pdb");}
